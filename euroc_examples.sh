#!/bin/bash
pathDatasetEuroc='./euroc_dataset' #Example, it is necesary to change it by the dataset path
...
python3 ../evaluation/evaluate_ate_scale.py ../evaluation/Ground_truth/EuRoC_left_cam/MH01_GT.txt f_dataset-MH01_mono.txt --plot MH01_mono.pdf
